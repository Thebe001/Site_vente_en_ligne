...
<body>
    ...
    <div class="header">
        <div class="container">
            ...
            <div>
                <p>
                <h3><?php echo "your delivery is on The way.Please don't forget to pay " . $_POST['total'] . " DT when being deleivered"
                    ?></h3>
                </p>
            </div>
            <div>
            ...
            $string = date("H:i:s", $_SESSION['delevint']);
            echo 'Your order arrives at'  . "  " . $string;
            if (strcmp(date("H:i:s"), $string) == 0) { ?>
            <script>
            alert('Your Waiting time is over.Your order is at your door')
            window.location.href = 'login.php'
            </script>
